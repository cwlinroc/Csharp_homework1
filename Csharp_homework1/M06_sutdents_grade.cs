...
namespace Csharp_homework1
{
    public partial class M06_sutdents_grade : Form
    {
        ...
        private class Students
        {
            ...
            public Students(string name, int score_01, int score_02, int score_03)
            {
                this.name = name;
        ...
        private void AddStudentToList(Students student)
        {
            ...
            item.SubItems.Add(((double)sum/subjectnumbers).ToString());//平均
        ...
        private void PrintResault(int[] sum, double[] average, int[] highestscore, int[] lowestscore)
        {
            ...
            {
                item_average.SubItems.Add(score.ToString());
            }
